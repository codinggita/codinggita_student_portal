...
import { Github, Linkedin, Globe, Mail, Edit3 } from "lucide-react";
import HeroPortfolioEdit from './HeroPortfolioEdit'
        ...
        : (<div className="min-h-screen bg-gray-900 text-white p-6 w-full pt-12">
          ...
          <div className="max-w-3xl mx-auto bg-gray-800 p-6 shadow-lg rounded-lg text-center relative">
            ...
            <div className="flex justify-center gap-4 mt-4">
              <a href={portfolioData.Socials.github} className="text-gray-400 hover:text-white"><Github /></a>
